<?php
    ...
    $sentencia = $base_de_datos->query("SELECT * FROM usuarios WHERE metodo='hashv1'");
...
<body>
    ...
    <div class="container"><br>
        ...
        <div class="row g-3">
            <div class="col-sm-10">
                <div class="card-header">
                    <h3><strong> Cifrado Hash V1 </strong> </h3>
                </div>
            </div>
        </div>
        <br>
        ...
        <div class="card" style="background-color: #fff; border-color:#D7D4D4;">
            <form action="./php/registrohash.php" method="Post">
                <div class="card-body">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>                        
                        <a href="<?php echo "./php/deletehashv1.php?id=".$usuario->idUsuario?>" type="button" class="btn btn-danger">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
                                <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5Zm-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5ZM4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06Zm6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528ZM8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5Z"></path>
                            </svg> Eliminar                                                   
                        </a>   
                        <a href="<?php echo "./hashv1Descifrar.php?id=".$usuario->idUsuario?>" type="button" class="btn btn-primary">
