...
<!--HEADER-->
    ...
    <div class="container"><br>
        ...
        <div class="card" style="background-color: #fff; border-color:#D7D4D4;">
            <form action="./php/actualizarCifradoPropio.php" method="Post">
                <div class="card-body">
                ...
                <div class="container-md">
                    ...
                    <div class="container-md">
                        ...
                        <input type="text" class="form-control" id="direccion" value="" required placeholder="Ingrese la dirección" name="direccion">
                    </div>
                    <div class="container-md">
                    ...
                    <div class="container-md">
                        ...
                        <input type="text" class="form-control" id="pass" value="" required placeholder="Ingrese la contraseña" name="pass">
                    </div>
